...
// NewGetGameStateParams creates a new GetGameStateParams object
// no default values defined in spec.
func NewGetGameStateParams() GetGameStateParams {

	return GetGameStateParams{}
}

// GetGameStateParams contains all the bound params for the get game state operation
...
func (o *GetGameStateParams) bindGameID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
