...
// NewPauseGameParams creates a new PauseGameParams object
// no default values defined in spec.
func NewPauseGameParams() PauseGameParams {

	return PauseGameParams{}
}

// PauseGameParams contains all the bound params for the pause game operation
...
func (o *PauseGameParams) bindGameID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
